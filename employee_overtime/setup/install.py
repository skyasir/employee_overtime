...
# Standard hours and break deduction defaults. Seeded once so a fresh
# install already matches the agreed policy; HR edits it in Overtime Setting.
# Pattern: an 8-hour shift deducts a 0.5h unpaid break; 9h and longer shifts
# do not. Both categories cover 8 / 9 / 10 / 12 hour shifts so any of those
# resolves to a rule instead of the global break fallback.
CATEGORY_RULES = [
    {"ot_category": "Staff", "shift_hours": 8, "deduct_break": 1, "break_hours": 0.5},
    {"ot_category": "Staff", "shift_hours": 9, "deduct_break": 0, "break_hours": 0},
    {"ot_category": "Staff", "shift_hours": 10, "deduct_break": 0, "break_hours": 0},
    {"ot_category": "Staff", "shift_hours": 12, "deduct_break": 0, "break_hours": 0},
    {"ot_category": "Worker", "shift_hours": 8, "deduct_break": 1, "break_hours": 0.5},
    {"ot_category": "Worker", "shift_hours": 9, "deduct_break": 0, "break_hours": 0},
    {"ot_category": "Worker", "shift_hours": 10, "deduct_break": 0, "break_hours": 0},
    {"ot_category": "Worker", "shift_hours": 12, "deduct_break": 0, "break_hours": 0},
]
